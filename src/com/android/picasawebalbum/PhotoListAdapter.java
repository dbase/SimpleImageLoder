...
import com.android.picasawebalbum.DrawableManager;
...
public class PhotoListAdapter extends BaseAdapter {
  ...
  public PhotoListAdapter(Context context,List<String> it)  {
  ...
  public View getView(int position,View conView,ViewGroup par)   {
    ...
    if(conView == null)  {
      ...
      holder.image = (ImageView)conView.findViewById(R.id.myPhotoImage);
